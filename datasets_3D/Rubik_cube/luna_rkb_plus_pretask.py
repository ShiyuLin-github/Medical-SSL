...
class RKBPLunaPretaskSet(RKBBase):
    """
          Luna Dataset for Rubik's cube + (RKB+).
          https://www.sciencedirect.com/science/article/pii/S1361841520301109
         """
    def __init__(self, config, base_dir, flag):
        super(RKBPLunaPretaskSet, self).__init__(config, base_dir, flag)
        self.config = config
        self.flag = flag
